    ...
    >
        ...
        >
            <Image
                ...
                className="size-6"
            />
            <Text className={`${textStyle} text-lg font-rubik-medium text-black-300`}>{title}</Text>
        </View>
...
const Profile = () => {
    ...
    const handleLogout = async () => {
        ...
        if (result) {
            Alert.alert("Success", "You have been successfully logout");
            refetch();
        } else {
            Alert.alert("Error", "An error occurred when logging out");
        }
    };
    ...
    return (
        <SafeAreaView className="h-full bg-white">
            ...
            >
                ...
                <View
                    className="flex justify-center flex-row mt-5"
                >
                    <View
